...
Train_dataS=zeros(Totalfiles,18);
Train_LabS=zeros(2,Totalfiles);
Train_LabS1=zeros(Totalfiles,1);
for PPP=1:Totalfiles
TempArray=sprintf('Sad/%d.mat',PPP);
TempArray1=sprintf('Sad/%d.jpg',PPP);
load(TempArray);
...
save Sdata.mat Train_dataS Train_LabS Train_LabS1