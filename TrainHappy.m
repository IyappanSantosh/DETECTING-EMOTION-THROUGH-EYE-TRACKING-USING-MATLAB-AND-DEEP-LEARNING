...
delete Hdata.mat;
FilePathStorage=pwd;
FilePathname1=strcat(FilePathStorage,'/Happy/');
FileNameListArray=dir([FilePathname1 '*.jpg']);
FileNameListArray1=dir([FilePathname1 '*.mat']);
Totalfiles=size(FileNameListArray1,1);
Train_dataH=zeros(Totalfiles,18);
Train_LabH=zeros(2,Totalfiles);
Train_LabH1=zeros(Totalfiles,1);
for PPP=1:Totalfiles
TempArray=sprintf('Happy/%d.mat',PPP);
TempArray1=sprintf('Happy/%d.jpg',PPP);
load(TempArray);
...
save Hdata.mat Train_dataH Train_LabH Train_LabH1